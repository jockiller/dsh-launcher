...
const zhDict = {
  ...
  appVersionChecking: "正在检查更新...",
  appVersionUpToDate: "已是最新版本",
  appVersionCheckFailed: "检查更新失败，请稍后重试。",
  appVersionChangelogEmpty: "当前版本没有更新说明。",
  ...
  dshVersionDialogTitle: "DSH 版本",
  dshVersionCheckTitle: "点击检查 DSH 更新",
  dshVersionCurrent: "当前版本",
  dshVersionLatest: "最新版本",
  dshCurrentNotesLabel: "当前版本更新内容",
  dshLatestNotesLabel: "新版本更新内容",
  dshVersionChecking: "正在检查 DSH 最新版本...",
  dshVersionUpToDate: "已是最新版本",
  openDshGitHub: "打开 DSH GitHub",
...
const enDict: Dict = {
  ...
  dshRestarting: "Waiting for DSH to restart",
  ...
  appVersionChecking: "Checking for updates...",
  appVersionUpToDate: "You are on the latest version",
  appVersionCheckFailed: "Failed to check for updates. Please try again later.",
  appVersionChangelogEmpty: "No release notes for this version.",
  ...
  dshVersionDialogTitle: "DSH Version",
  dshVersionCheckTitle: "Click to check for DSH updates",
  dshVersionCurrent: "Current version",
  dshVersionLatest: "Latest version",
  dshCurrentNotesLabel: "Current release notes",
  dshLatestNotesLabel: "New release notes",
  dshVersionChecking: "Checking for the latest DSH version...",
  dshVersionUpToDate: "You are on the latest version",
  openDshGitHub: "Open DSH GitHub",
...
const backendExact: Record<string, string> = {
  ...
  "DSH 服务运行中（插件已完成重启）": "DSH service is running after a plugin restart",
  "DSH 正在由插件重启，等待新的服务进程...":
    "DSH is restarting via a plugin; waiting for the new process...",
  "DSH 已退出，未找到插件重启的服务进程":
    "DSH exited and no plugin-restarted process was found",
